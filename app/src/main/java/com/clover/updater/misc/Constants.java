 ...
 */
package com.clover.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_ALLOW_MAJOR_UPGRADES = "clover.updater.allow_major_upgrades";
    public static final String PROP_BUILD_DATE = "ro.build.date.utc";
    public static final String PROP_BUILD_VERSION = "ro.clover.build.version";
    public static final String PROP_DEVICE = "ro.clover.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.clover.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "clover.updater.allow_downgrading";

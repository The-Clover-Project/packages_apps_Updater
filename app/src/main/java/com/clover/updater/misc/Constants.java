...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.clover.version";
    ...
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "clover.updater.allow_major_update";
